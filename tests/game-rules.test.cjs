...
(async () => {
  ...
  assert.equal(iceView.winColors.draw, '#2fa98e', 'Ice Stage draw segment avoids the orange-like gold');
  assert.equal(iceView.winColors.drawText, '#1f7a66', 'Ice Stage draw label follows the draw segment colour');
